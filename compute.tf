module "asg" {
  ...
  iam_role_policies = {
    ...
    DBConfig                     = aws_iam_policy.ssm_db_config_read.arn
    S3Config                     = aws_iam_policy.ssm_s3_config_read.arn
    ArtifactRead                 = aws_iam_policy.s3_artifact_read.arn
    AssetsAccess                 = aws_iam_policy.s3_assets_full_access.arn
  }
